...
6. Run `python3 scripts/build.py`, `python3 scripts/validate.py`, and `python3 scripts/validate.py --online`. Preview both READMEs and check image proportions, links to the matching AILesson recipe, and prompt expansion. Reader-facing galleries show output thumbnails only; reference images stay in the provenance records.
