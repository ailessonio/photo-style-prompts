...
- `palette` — Palette and mood: Porcelain ivory mountain peaks, muted evergreen trees, a translucent turquoise lake and a small terracotta roof; warm off-white studio backdrop.
...
- `palette`: Porcelain ivory mountain peaks, muted evergreen trees, a translucent turquoise lake and a small terracotta roof; warm off-white studio backdrop.

The scene is deliberately reframed onto a miniature base. A second edit removed roof lettering and simplified the mountains and trees. The house and forest remain recognizable, but scale and distant geography are compressed.

## Check the result

- Compare the left/right relationships of the main landmarks; the camera angle and scale are intentionally changed.
- Check the landmark relationships, complete base and clear water edge; avoid disconnected floating pieces or added buildings.
- Inspect small features at full size and remove accidental lettering before sharing.

[AILesson](https://ailesson.io/prompts/recipes/turn-photos-into-3d-miniature-worlds) · [Image credits](../IMAGE_CREDITS.md) · [Gallery](../README.md)
