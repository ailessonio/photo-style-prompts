...
- `palette` — Palette and mood: Cool white and pale cyan mesh lines on deep midnight blue; a small electric-lime shoreline accent.
...
- `palette`: Cool white and pale cyan mesh lines on deep midnight blue; a small electric-lime shoreline accent.

The bay and settlement remain recognizable, with a clear lime shoreline accent. The distant terrain is densely traced and dark; mesh geometry is illustrative rather than surveyed.

## Check the result

- Compare the main silhouette, viewpoint and left/right relationships with the uploaded photo.
- Look for a recognizable coast, coherent slopes and readable houses; remove arbitrary grids or coordinates.
- Inspect small features at full size and remove accidental lettering before sharing.

[AILesson](https://ailesson.io/prompts/recipes/turn-photos-into-digital-wireframe-landscapes) · [Image credits](../IMAGE_CREDITS.md) · [Gallery](../README.md)
