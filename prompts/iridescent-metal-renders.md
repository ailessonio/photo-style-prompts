...
- `palette` — Palette and mood: Pearlescent silver shifting subtly through lilac, ice blue and pale pink, with a warm white studio environment.
...
- `palette`: Pearlescent silver shifting subtly through lilac, ice blue and pale pink, with a warm white studio environment.

The bouquet and vase remain clear, with subtle pink-blue metal reflections and a pale basket. Background plants and small tabletop objects are omitted, and the bow is simplified.

## Check the result

- Compare the main silhouette, viewpoint and left/right relationships with the uploaded photo.
- Check that the main silhouettes survive and the silver areas remain calm instead of becoming saturated rainbow noise.
- Inspect small features at full size and remove accidental lettering before sharing.

[AILesson](https://ailesson.io/prompts/recipes/turn-photos-into-iridescent-metal-renders) · [Image credits](../IMAGE_CREDITS.md) · [Gallery](../README.md)
