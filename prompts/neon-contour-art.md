...
- `subject` — Essential elements: The fluffy sleeping cat resting on the white windowsill, with its lowered head and hanging foreleg, the window on the left, and the ladder on the right.
- `palette` — Palette and mood: Icy cyan contours with a very small violet accent on a near-black navy background; calm futuristic atmosphere.
...
- `subject`: The fluffy sleeping cat resting on the white windowsill, with its lowered head and hanging foreleg, the window on the left, and the ladder on the right.
- `palette`: Icy cyan contours with a very small violet accent on a near-black navy background; calm futuristic atmosphere.

The cat, hanging paw and tail are clear in luminous contours. The eyes look more open than in the reference, and some window edges are as bright as the subject; the image is a stylized interpretation.

## Check the result

- Compare the main silhouette, viewpoint and left/right relationships with the uploaded photo.
- Check the eyes, muzzle and silhouette; background lines should be dimmer and the glow should not merge nearby features.
- Inspect small features at full size and remove accidental lettering before sharing.

[AILesson](https://ailesson.io/prompts/recipes/turn-photos-into-neon-contour-art) · [Image credits](../IMAGE_CREDITS.md) · [Gallery](../README.md)
