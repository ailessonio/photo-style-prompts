...
- `palette` — Palette and mood: Deep indigo and muted terracotta ink on warm cream paper; quiet afternoon, strong readable silhouettes.
...
- `palette`: Deep indigo and muted terracotta ink on warm cream paper; quiet afternoon, strong readable silhouettes.

The cat's pose, window and ladder are preserved with strong indigo and terracotta areas. Fine fur marks and a thin paper margin remain; this is simulated print texture, not an actual pulled print.

## Check the result

- Compare the main silhouette, viewpoint and left/right relationships with the uploaded photo.
- Look for carved channels and directional fur marks, with the sleeping face and hanging limb still intact.
- Inspect small features at full size and remove accidental lettering before sharing.

[AILesson](https://ailesson.io/prompts/recipes/turn-photos-into-two-color-linocuts) · [Image credits](../IMAGE_CREDITS.md) · [Gallery](../README.md)
