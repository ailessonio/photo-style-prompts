...
- `scene` — Scene and essential landmarks: A snow-capped mountain left of center, still lake and reflections, a dark timber boathouse with one warm window on the right, its jetty extending left, and evergreen trees behind it.
- `palette` — Palette and mood: Muted cobalt and blue-gray with subdued evergreen and a small amber window glow; peaceful winter blue hour.
- `caption` — Optional caption: NONE, or a short phrase such as Lake at dusk
...
- `scene`: A snow-capped mountain left of center, still lake and reflections, a dark timber boathouse with one warm window on the right, its jetty extending left, and evergreen trees behind it.
- `palette`: Muted cobalt and blue-gray with subdued evergreen and a small amber window glow; peaceful winter blue hour.
- `caption`: NONE

The first watercolor draft filled too much of the page. A targeted edit reduced the scene to roughly half the canvas width; fine brush details changed slightly. The draft remains in the recipe assets.

## Check the result

- Compare the result with the photo: are the key silhouettes, viewpoint and left/right relationships preserved?
- Does the scene occupy roughly half the page width with visible ivory paper on all sides?
- Look for watercolor washes and irregular edges rather than a photo with a texture filter; check any caption character by character.

[AILesson](https://ailesson.io/prompts/recipes/turn-photos-into-watercolor-travel-prints) · [Image credits](../IMAGE_CREDITS.md) · [Gallery](../README.md)
